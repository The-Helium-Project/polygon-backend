...
export interface ProtoLike {
    encode: (message: any, writer?: protobuf.Writer | undefined) => protobuf.Writer
    decode: (reader: Uint8Array, length?: number | undefined) => unknown,
    fromObject: (object: { [k: string]: any; }) => any,
    toObject: (message: any, options?: object) => { [k: string]: any; }
}

type RequestMessagesResponses = {
    [ key: string ]: [ number, ProtoLike | null, ProtoLike | null ]
}

const requestMessagesResponses: RequestMessagesResponses = {
...
const requestResponses: { [ key: number]: [any, any] } = {};
Object.values(requestMessagesResponses).forEach(([ id, request, response ]) => requestResponses[id] = [ request, response ]);
